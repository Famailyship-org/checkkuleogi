...
@Component
public class BookRegisterManager {   // 추후 BookManager에 합병되고, GPT API 책임 클래스에 의존하도록 변경 고려
    ...
    public Book createBook(BookMBTIRequest req) {
        Integer[] mbti = getMbtiFromLLM(req);
        ...
        Book book = Book.builder()
                ...
                .mbti(calculateMBTI(mbti[0], mbti[1], mbti[2], mbti[3]))
                .bookMBTI(bookMBTI)
                .build();
    ...
    private Integer[] getMbtiFromLLM(BookMBTIRequest req) {
